...
class Admin extends CI_Controller
{
    ...
    public function system_settings($param1 = "")
    {
        ...
        if ($param1 == 'favicon_upload') {
            move_uploaded_file($_FILES['favicon1']['tmp_name'], 'assets/favicon1.png');
            ...
            foreach ($courses as $key => $row) {
                ...
                if ($row['status'] == 'active') {
                    ...
                    $course_status_changing_message = get_phrase('mark_as_active');
                        ...
                        $course_status_changing_action = "confirm_modal('" . site_url('admin/change_course_status_for_admin/active/' . $row['id'] . '/' . $category_id . '/' . $instructor_id . '/Free/' . $status) . "')";
