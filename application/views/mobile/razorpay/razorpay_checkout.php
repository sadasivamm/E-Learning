...
<html lang="en">
	<head>
		...
		<link name="favicon" type="image/x-icon" href="<?php echo base_url('uploads/system/'.get_settings('favicon1'));?>" rel="shortcut icon" />
	...
	<body style="background-color: #fff !important;">
		...
		<script>
			...
			"handler": function (response){
		        ...
		        var redirectUrl = "<?php echo site_url('home/razorpay_payment/'.$payment_request.'?user_id='.$user_details['id'].'&amount='.$amount_to_pay.'&razorpay_order_id='); ?>" + response.razorpay_order_id + "&payment_id=" + response.razorpay_payment_id + "&signature=" + response.razorpay_signature;
