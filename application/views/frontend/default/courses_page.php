...
<section class="category-header-area" style="background-image: url('<?php echo base_url('uploads/system/course_page_banner.png'); ?>'); background-size: cover; background-position: right;">
                ...
                <div class="row category-filter-box mx-0 box-shadow-4" >
                    ...
                    <div class="col-md-6 text-end filter-sort-by">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <input id="sortByValue" type="hidden" name="sort_by" value="<?php echo (isset($_GET['sort_by'])) ? $_GET['sort_by'] : 'newest';  ?>">
                            ...
                            <button class="btn bg-background dropdown-toggle fw-bold text-capitalize" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                <?php
                                if(isset($_GET['sort_by']) && $_GET['sort_by'] == 'highest-rating'):
                                    echo get_phrase('highest_rating');
                                elseif(isset($_GET['sort_by']) && $_GET['sort_by'] == 'lowest-price'):
                                    echo get_phrase('lowest_price');
                                elseif(isset($_GET['sort_by']) && $_GET['sort_by'] == 'highest-price'):
                                        echo get_phrase('highest_price');
                                elseif(isset($_GET['sort_by']) && $_GET['sort_by'] == 'discounted'):
                                        echo get_phrase('discounted');
                                else:
                                    echo get_phrase('newest');
                                endif;
                                ?>
                            </button>
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
                                <li><a onclick="courseSorting('newest')" class="dropdown-item text-12px fw-600 text-capitalize" href="javascript:;"><?php echo get_phrase('newest'); ?></a></li>
                                <li><a onclick="courseSorting('highest-rating')" class="dropdown-item text-12px fw-600 text-capitalize" href="javascript:;"><?php echo get_phrase('highest_rating'); ?></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
