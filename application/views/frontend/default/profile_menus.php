    ...
    <ul class="print-hidden">
      ...
      <?php //course_addon start
        if (addon_status('tutor_booking')) : ?>
          <li class="<?php if( $page_name=='booked_schedule_student' ) echo 'active'; ?>"><a href="<?php echo site_url('my_bookings'); ?>"> <i class="far fa-user-history"></i> <?php echo site_phrase('Booked Tutions '); ?></a></li>
      <?php endif; ?>
      ...
      if (addon_status('affiliate_course')) :
        ...
        if ($x == 1) : ?>
          ...
          <li class="<?php if ($page_name == 'affiliate_course_history') echo 'active'; ?>"><a href="<?php echo site_url('addons/affiliate_course/affiliate_course_history'); ?>"> <i class="fas fa-poll"></i> <?php echo site_phrase('Affiliate History '); ?></a></li>
