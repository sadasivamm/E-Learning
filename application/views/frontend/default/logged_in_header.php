    ...
    <div class="container-xl">
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <ul class="mobile-header-buttons">
                ...
                <li><a class="mobile-search-trigger" href="#mobile-search">Short Videos<span></span></a></li>
            </ul>

            <a href="<?php echo site_url(''); ?>" class="navbar-brand pt-2 mt-1">
                <img src="<?php echo base_url('uploads/system/' . get_frontend_settings('dark_logo')); ?>" alt="" height="45">
            </a>
            ...
            <div class="instructor-box menu-icon-box">
                <div class="icon">
                    <a href="<?php echo site_url('home/reels'); ?>" style="border: 1px solid transparent; margin: 0px; font-size: 14px; width: max-content; border-radius: 5px; max-height: 40px; line-height: 40px; padding: 0px 8px;">Reels</a>
                </div>
            </div>
