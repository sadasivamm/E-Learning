                                                ...
                                                <div class="form-group row mb-3">
                                                    <div class="offset-md-2 col-md-10">
                                                        <div class="custom-control custom-checkbox">
                                                            ...
                                                            <input type="checkbox" class="custom-control-input" name="is_private" id="is_private" value="1" <?php if($course_details['status'] == 'private') echo 'checked'; ?>>
                                                            <label class="custom-control-label" for="is_private"><?php echo get_phrase('keep_it_as_a_private_course'); ?></label>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xl-8">
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <div id = "faq_area">
                                                            <?php $faq_counter = 0; ?>
                                                            <?php foreach(json_decode($course_details['faqs'], true) as $faq_title => $faq_description): ?>
