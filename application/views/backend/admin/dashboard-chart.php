...
?>
 ...
 ! function(o) {
     ...
     t.prototype.respChart = function(r, a, n, e) {
         ...
         if (0 < o("#project-status-chart1").length) {
             t.push(this.respChart(o("#project-status-chart1"), "Doughnut", {
                 labels: ["Watched Videos", "Liked Videos", "Disliked Videos"],
                 datasets: [{
                     data: [16, 12, 4],
                     backgroundColor: ["Blue", "#0acf97", "Red"],
                     borderColor: "transparent",
                     borderWidth: "2"
                 }]
             }, {
         ...
         if (0 < o("#project-status-chart2").length) {
             t.push(this.respChart(o("#project-status-chart2"), "Line", {
