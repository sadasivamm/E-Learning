...
class Api_model extends CI_Model
{
	...
	public function system_settings_get()
	{
		...
		$system_settings_data['thumbnail'] = base_url() . 'uploads/system/'.get_frontend_settings('dark_logo');
		$system_settings_data['favicon1'] = base_url() . 'uploads/system/'.get_frontend_settings('favicon1');
		return $system_settings_data;
	}
	...
	public function signup_post()
	{
        ...
        if($validity === 'unverified_user' || $validity == true) {
        	if($validity === true){
				...
				require '../../shorts/king-include/king-app/users-edit.php';
				
				$userid = qa_create_new_user($_POST['email'], $_POST['password'], $_POST['first_name']+$_POST['last_name'] );
