...
/*
	...
	File: king-include/king-db-hotness.php
...
*/
	{
		...
		if (qa_should_update_counts()) {
			...
			//	Additional multiples based on empirical analysis of activity on KINGMEDIA meta site to give approx equal influence for all factors
