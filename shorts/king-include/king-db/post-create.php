...
*/
	...
	function qa_db_post_create($type, $parentid, $userid, $cookieid, $ip, $title, $content, $format, $tagstring, $notify, $categoryid=null, $name=null, $postformat=null, $pcontent=null, $nsfw=null)
/*
	Create a new post in the database and return its ID (based on auto-incrementing)
*/
	{
		qa_db_query_sub(
			'INSERT INTO ^posts (categoryid, type, parentid, userid, cookieid, createip, title, content, format, tags, notify, name, created, postformat, pcontent, nsfw) '.
			'VALUES (#, $, #, $, #, INET_ATON($), $, $, $, $, $, $, NOW(), $, $, $)',
			$categoryid, $type, $parentid, $userid, $cookieid, $ip, $title, $content, $format, $tagstring, $notify, $name, $postformat, $pcontent, $nsfw
		);
